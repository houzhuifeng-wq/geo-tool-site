...
export default function QADetailPage() {
  ...
  const [qaItem, setQaItem] = useState<any>(null);
  ...
  useEffect(() => {
    ...
    if (savedQAs) {
      ...
      // 查找对应ID的问答
      const foundItem = items.find((item: any) => item.id === qaId);
      // 检查问答是否存在且已发布
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="py-12 pt-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">问题不存在</h1>
            <p className="text-gray-600 mb-8">您访问的问题不存在或已被删除。</p>
            <Link 
              href="/qa" 
      ...
      <section className="py-12 pt-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-8">{qaItem.question}</h1>
