    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 pt-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">查看优化案例</h1>
              ...
              {cases.map((item) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="text-gray-600">{item.excerpt || item.content.substring(0, 100) + '...'}</p>
